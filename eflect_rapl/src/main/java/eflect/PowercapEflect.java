...
public final class PowercapEflect {
  ...
  public void start(long periodMillis) {
    ...
    footprints.clear();
    eflect = new PowercapEflectCollector(mergeAttempts, executor, Duration.ofMillis(periodMillis));
    eflect.start();
  }
