...
JNIEXPORT jint JNICALL Java_eflect_util_Rapl_ProfileInit(JNIEnv *env, jclass jcls) {
	jintArray result;
	int i;
...
JNIEXPORT jint JNICALL Java_eflect_util_Rapl_GetSocketNum(JNIEnv *env, jclass jcls) {
...
JNIEXPORT jstring JNICALL Java_eflect_util_Rapl_EnergyStatCheck(JNIEnv *env,
		jclass jcls) {
	jstring ener_string;
...
JNIEXPORT void JNICALL Java_eflect_util_Rapl_ProfileDealloc
